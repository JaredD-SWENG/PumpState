...
/// Generates the calendar used for scheduling workouts
    ...
    return TableCalendar(
      ...
      calendarBuilders: CalendarBuilders(
        dowBuilder: (context, day) {
          String weekday = ""; // Initializes the day of week to empty string
          // Sets the top header to the day of week short
          switch (day.weekday) {
            case 1:
              weekday = "M";
              break;
